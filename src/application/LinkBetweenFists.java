...
public class LinkBetweenFists extends GameApplication {
    ...
    protected void initPhysics() {
        FXGL.getPhysicsWorld().addCollisionHandler(new CollisionHandler(EntityType.PLAYER, EntityType.BOW) {
            @Override
            protected void onCollisionBegin(Entity player, Entity bow) {
                bow.removeFromWorld();
            }
        });
    }
