...
* @version 3/9/20
*/
public class Player4 extends Component {
    ...
    public Player4() {
        animIdle = new AnimationChannel(FXGL.image("link4_walk.png"), 2, 64, 64, Duration.seconds(1), 0, 1);
        animLeft = new AnimationChannel(FXGL.image("link4_walk.png"), 2, 64, 64, Duration.seconds(1), 6, 7);
        animRight = new AnimationChannel(FXGL.image("link4_walk.png"), 2, 64, 64, Duration.seconds(1), 4, 5);
        animUp = new AnimationChannel(FXGL.image("link4_walk.png"), 2, 64, 64, Duration.seconds(1), 2, 3);
        animDown = new AnimationChannel(FXGL.image("link4_walk.png"), 2, 64, 64, Duration.seconds(1), 0, 1);
        swordAttackLeft = new AnimationChannel(FXGL.image("link4_item.png"), 1, 64, 64, Duration.seconds(1), 3, 3);
        swordAttackRight = new AnimationChannel(FXGL.image("link4_item.png"), 1, 64, 64, Duration.seconds(1), 2, 2);
        swordAttackUp = new AnimationChannel(FXGL.image("link4_item.png"), 1, 64, 64, Duration.seconds(1), 1, 1);
        swordAttackDown = new AnimationChannel(FXGL.image("link4_item.png"), 1, 64, 64, Duration.seconds(1), 0, 0);
    ...
    public void onUpdate(double tpf) {
        if(wall == null)
            wall = FXGL.getGameWorld().getEntitiesByType(BUSH,PLAYER4);
