...
* @version 3/9/20
*/
public class Player3 extends Component {
    ...
    public Player3() {
        animIdle = new AnimationChannel(FXGL.image("link2_walk.png"), 2, 64, 64, Duration.seconds(1), 0, 1);
        animLeft = new AnimationChannel(FXGL.image("link2_walk.png"), 2, 64, 64, Duration.seconds(1), 6, 7);
